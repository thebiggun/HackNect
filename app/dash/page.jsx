                                ...
                                {loading ? (
                                    ...
                                    <div className="space-y-4">
                                        {registrations.map((registration) => (
                                            <div 
                                                key={registration.id}
                                                className="bg-[#181c23] border-2 border-[#232935] rounded-lg p-4 hover:border-purple-400/30 hover:shadow-[0_0_24px_4px_rgba(168,85,247,0.15)] transition-all duration-300"
                                            >
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex gap-2">
                                                        <Link
                                                            href={`/explore/${registration.hackathon_id}/register`}
