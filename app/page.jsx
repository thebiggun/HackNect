...
const FEATURES = [
  ...
  // New AI First Round Selection Feature
  {
    icon: <Trophy className="w-7 h-7 text-green-400" />,
    title: "AI First Round Selection",
    desc: "Let AI shortlist the best ideas in the first round for faster, unbiased, and efficient judging."
  },
];
